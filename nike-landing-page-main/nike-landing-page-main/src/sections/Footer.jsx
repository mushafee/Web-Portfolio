    ...
    <footer className='max-container'>
      ...
      gap-20 flex-wrap max-lg:flex-col'>
        <div className='flex flex-col items-start'>
          ...
          sm:max-w-sm'>Get shoes ready for the new term at your nearest 
          ...
          <div className='flex items-center gap-5 mt-8'>
            {socialMedia.map((icon) => (
              ...
              w-12 h-12 bg-white rounded-full hover:scale-110
              hover:bg-coral-red duration-500'>
                <img 
                src={icon.src} 
                alt={icon.alt}
                width={24}
            ...
            <div key={section}>
              ...
              <ul>
                {section.links.map((link) => (
                  ...
                  hover:text-coral-red cursor-pointer'
                  key={link.name}>
                    <a>{link.name}</a>
                  </li>
                ))}
      ...
      mt-24 max-sm:flex-col max-sm:items-center'>
        ...
        hover:text-coral-red'>Terms & Conditions</p>
      </div>
    </footer>
  )
}
